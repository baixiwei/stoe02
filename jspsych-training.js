...
( function ( $ ) {
    ...
    jsPsych.training = (function() {
        ...
        plugin.trial = function( $this, block, trial, part ) {
            ...
            var presenter = new functionPresenter( specs.functionType, specs.spatialOrg, specs.temporalOrg, onClick );
            ...
            var handleSubmit = function() {
                ...
                if ( ready ) {
                    ...
                    if ( trial_data.resp_last_acc==1 ) {
                        ...
                        ready   = true;
                        delay   = 0;
                    } else if ( trial_data.num_resp >= maxtries ) {
                        ...
                        // answer was incorrect, not yet reached max errors - make them try again
